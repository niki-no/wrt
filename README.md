...
[![Firmware-Build](https://github.com/niki-no/wrt/actions/workflows/Firmware-Build.yml/badge.svg)](https://github.com/niki-no/wrt/actions/workflows/Firmware-Build.yml)
...
1. 在仓库根目录放置配置文件夹（可参考lean-x86-64或immo-x86-64文件夹）
...
3. 增减插件需自行修改scripts/addon.sh和配置文件夹下config.diff文件
...
4. 插件都为网上寻找，插件作者仓库可在scripts/addon.sh文件中查看，在此表示感谢！
